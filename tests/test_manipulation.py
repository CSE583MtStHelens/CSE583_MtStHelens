...
class Test_Manipulation(unittest.TestCase):
    ...
    def test_smoke_manipulation_A(self):
        ...
        df = pd.DataFrame(data, index=pd.date_range('2004-01-01', periods=100, freq='D'))
    ...
    def test_smoke_manipulation_B(self):
        ...
        df = pd.DataFrame(data, index=pd.date_range('2007-01-01', periods=100, freq='D'))
    ...
    def test_stack_space_yearparam_A(self):
        ...
        df_stackSpace_year = pd.DataFrame(data, index=['01/01 00:00:00',
                                                       '01/01 01:00:00',
                                                       '01/01 02:00:00',
                                                       '01/01 03:00:00'])
    ...
    def test_stack_space_yearparam_B(self):
        ...
        df_stackSpace_year = pd.DataFrame(data, index=
                                          ['01/01 00:00:00',
                                           '01/01 01:00:00',
                                           '01/01 02:00:00',
                                           '01/01 03:00:00'])
    ...
    def test_stackInSpace_handles_leap_years(self):
        leap_year_df = pd.DataFrame({'value': [1, 2, 3]},
    ...
    def test_stack_in_time(self):
        ...
        Ensures that the type and shape of the output data is as expected and that
        the original df is unaltered
        """
        # Create a sample DataFrame for testing
        ...
        self.assertEqual(seasonal_data.shape, (24 * 6 * 365, 3)) # 24 h * 6 10-min intervals * 365 d
